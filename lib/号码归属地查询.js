...
ui.layout(
    <frame background="#515155">
        <vertical align="top" margin="30">
            ...
            <linear>
                <text h="auto" w="auto" text="手机号码段：" textSize="18sp" />
                <text id="sj" h="30" w="auto" textSize="18sp" />
            </linear>
            <linear>
                <horizontal>
                    <text h="auto" w="auto" text="卡号归属地：" textSize="18sp" />
                    <text id="gsd" h="auto" w="auto" textSize="18sp" />
                </horizontal>
            </linear>
            <linear>
                <horizontal>
                    <text h="auto" w="auto" text="卡类型：" textSize="18sp" />
                    <text id="klx" h="30" w="auto" textSize="18sp" />
                </horizontal>
            </linear>
            <linear>
                <horizontal>
                    <text h="auto" w="auto" text="区号：" textSize="18sp" />
                    <text id="qh" h="30" w="auto" textSize="18sp" />
                </horizontal>
            </linear>
            <linear>
                <horizontal>
                    <text h="auto" w="auto" text="邮政编码：" textSize="18sp" />
